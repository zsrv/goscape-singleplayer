...
require (
	...
	github.com/zsrv/goscape-client v0.0.0-00010101000000-000000000000
)
...
replace (
	github.com/zsrv/goscape => ../goscape-rev245.2
	github.com/zsrv/goscape-client => ../goscape-client-rev245.2
)
